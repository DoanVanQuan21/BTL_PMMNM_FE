...
<template>
  <div class="container-lg header" id="app">
    <div class="row pt-5 ms-auto me-auto">
        <div class="col-lg-6 background_login text-center" id="" >
        ...
        <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-12 ms-5" id="login-form">
                        ...
                        <form>
                                <div class="row py-2">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control rounded-pill border border-1 border-dark" id="fullname" name="fullname" v-bind="userCredentials.fullname" aria-describedby="nameHelp" placeholder="nhập họ tên" >
                                ...
                                <div class="row py-2">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control rounded-pill border border-1 border-dark" id="username" name="username" v-model="userCredentials.username" aria-describedby="nameHelp" onkeyup="checkValidLogin()" placeholder="nhập tên tài khoản">
                                                <div id="errName"></div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row py-2">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-10">
                                                <input type="password" class="form-control rounded-pill border border-dark" id="password" name="password" v-model="userCredentials.password" onkeyup="checkValidLogin()" placeholder="nhập mật khẩu">
                                                <div id="errPass"></div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row py-2">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-10">
                                                <input type="password" class="form-control rounded-pill border border-dark" id="ConfirmPassword" name="userCredentials.confirmPassword" onkeyup="checkValidLogin()" placeholder="xác nhận mật khẩu">
                                                <div id="errPass"></div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-10">
                                                  <select id="inputPermission" name="permission" class="form-control rounded-pill border border-dark">
                                                    <option v-for="(perm, index) in userCredentials.permission" :key="index" :value="perm">{{ perm }}</option>
                                                  </select>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row py-2">
                                    <div class=" col-lg-10 text-end btn-create-account">
                                        ...
                                        <i class="fa-solid fa-right-to-bracket" ></i>Tạo tài khoản</button>
                                    </div>
                                </div>
                        </form>
                    </div>
